...
# save_path       = f"./model/raw_linear-mix_sampling-{settings['model']['num_layers']}_layers-{settings['model']['model_dim']}_features-lr={settings['training']['lr']}-batch={settings['training']['batch_size']}"
